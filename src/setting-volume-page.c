...
//		elm_box_pack_end(box, page_layout);
		...
		evas_object_smart_callback_add(slider, "value,changed", _value_changed, pd);
	...
	//eext_rotary_event_handler_add(_value_changed_rotary, pd);
