...
static void _response_vibration_ok_cb(void *data, Evas_Object *obj, void *event_info)
{
	...
	case VIBRATION_LEVEL_NONE:
		vconf_set_int(VCONFKEY_SETAPPL_NOTI_VIBRATION_LEVEL_INT, VIBRATION_LEVEL_NONE_INT);
		vconf_set_int(VCONFKEY_SETAPPL_TOUCH_FEEDBACK_VIBRATION_LEVEL_INT, VIBRATION_LEVEL_NONE_INT);
		break;
	default:
		break;
	}
